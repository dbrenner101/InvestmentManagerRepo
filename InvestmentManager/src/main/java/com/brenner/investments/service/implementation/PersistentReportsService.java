...
import com.brenner.investments.service.ReportsService;
 ...
 */
@Service
public class PersistentReportsService implements ReportsService {
	
	private static final Logger log = LoggerFactory.getLogger(PersistentReportsService.class);
    ...
    public PortfolioReport getTotalChangeInPortfolio() throws QuoteRetrievalException {
        ...
        Iterable<Holding> holdingsIter = this.holdingsRepo.findAll();
