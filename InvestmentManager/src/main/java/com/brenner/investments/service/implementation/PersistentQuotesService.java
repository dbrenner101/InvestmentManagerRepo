 ...
 */
@Service
public class PersistentQuotesService implements QuotesService {
    ...
    /**
     * Injection of the QuoteRepository - testing support
     * 
     * @param quoteRepo
     */
    public void setQuoteRepo(QuotesDataService quoteRepo) {
		this.quotesDataService = quoteRepo;
	}

    /**
     * Injection of the investment service = testing support.
     * 
     * @param investmentsService
     */
	public void setInvestmentsService(InvestmentsService investmentsService) {
		this.investmentsService = investmentsService;
	}

	/**
	 * Injection of the QuoteRetrievalService - testing support
	 * @param quotesService
	 */
	public void setQuotesService(QuoteRetrievalService quotesService) {
		this.quotesRetrievalService = quotesService;
	}
    ...
    public void deleteQuote(Quote quote) {
    	this.quotesDataService.delete(quote);
    }
    ...
    private void saveAllQuotes(List<Quote> quotes) {
    	this.quotesDataService.saveAll(quotes);
    }
    ...
    public List<Quote> findAllByInvestmentId(Long investmentId) {
    	...
    	return this.quotesDataService.findAllByInvestmentInvestmentId(investmentId);
    }
    ...
    public Quote getQuoteBySymbolAndDate(String symbol, Date date) {
        ...
        return this.quotesDataService.findByInvestmentSymbolAndDate(symbol, date);
    }
    ...
    public Date findGreatestQuoteDateForSymbol(String symbol) throws ParseException {
        ...
        String dateString = this.quotesDataService.findMaxDateBySymbol(symbol);
    ...
    public List<Quote> getAllQuotesBySymbol(String symbol) {
        ...
        return this.quotesDataService.findAllByInvestmentSymbol(symbol);
    }
    ...
    private Quote saveQuote(Quote quote) {
        return this.quotesDataService.save(quote);
    }
	...
	public void addQuotes(List<Quote> quotes) {
		...
		this.quotesDataService.saveAll(quotesToSave);
	}
