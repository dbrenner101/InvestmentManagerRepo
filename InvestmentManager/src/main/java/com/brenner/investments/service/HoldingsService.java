...
import com.brenner.investments.data.InvalidDataRequestException;
...
public class HoldingsService {
    ...
    public List<Holding> getHoldingsForAccount(Long accountId) {
        ...
        return this.holdingsRepo.findByAccountAccountId(accountId);
    }
    ...
    public Holding getHoldingByHoldingIdWithBuyTransaction(Long holdingId) {
    	...
    	if (optHolding.isPresent()) {
    		h = optHolding.get();
        	Transaction transaction = this.transactionsService.getBuyTransactionsForHoldingId(holdingId);
