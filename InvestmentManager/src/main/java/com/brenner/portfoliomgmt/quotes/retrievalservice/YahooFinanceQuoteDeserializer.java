 ...
 * 
 */
public class YahooFinanceQuoteDeserializer extends StdDeserializer<QuoteDTO> {
     ...
     */
	@Override
	public QuoteDTO deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JacksonException {
