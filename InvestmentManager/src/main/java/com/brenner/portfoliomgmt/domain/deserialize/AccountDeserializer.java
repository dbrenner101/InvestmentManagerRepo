...
/**
 * Class to convert a JSON stream to an {@link AccountDTO} object
 * 
 * @author dbrenner
 *
 */
public class AccountDeserializer extends StdDeserializer<Account> {
	...
	/**
	 * Reads the {@link JsonNode} into an {@link AccountDTO} object
	 * 
	...
	public Account deserialize(JsonNode json) {
		...
		a.setAccountId(json.get("accountId") != null ? json.get("accountId").asLong() : null);
